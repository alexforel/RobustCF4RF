"""
Illustrate the robust target score as a function:
 - compare forest score and tree score,
...
# --- 1/ Forest probability and tree probability --- #
...
# --- 2/ Varying α, fixed N --- #
# Plot the target score threshold as a funciton of the robustness target
plt.figure()
...
# Plot the target score threshold as a funciton of the forest size
...
data = np.array((nbTreesVector, p_star_vector_alpha1,
                p_star_vector_alpha2, p_star_vector_alpha3,
